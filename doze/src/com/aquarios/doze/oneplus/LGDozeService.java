...
public class LGDozeService extends Service {
    private static final String TAG = "LGDozeService";
    ...
    private LGProximitySensor mSensor;
    ...
    class LGProximitySensor implements SensorEventListener {
        ...
        public LGProximitySensor(Context context) {
    ...
    public void onCreate() {
        if (DEBUG) Log.d(TAG, "LGDozeService Started");
        mContext = this;
        mPowerManager = (PowerManager)getSystemService(Context.POWER_SERVICE);
        mSensor = new LGProximitySensor(mContext);
        mWakeLock = mPowerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "LGDozeWakeLock");
